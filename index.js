...
For example, mortgageCalculator(2000000, 0.05, 30); <-- should return 1,073.64  */
...
function variableInterestRate(P, I, N) {
    ...
    let name = "Mike Benton"
    I -= .02;  //"plus or minus 2% from the inputted interest rate"
    let periods = N * 12;
    ...
    for( let i = 0 ; i < 10 ; i++ ){
        ...
        //NEED TO INCRIMENT FOR THE NEXT LOOP
        I += .005;
